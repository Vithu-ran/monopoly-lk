...
static const Square BOARD_TEMPLATE[BOARD_SIZE] = {
    ...
    {5, "Colombo Fort Railway Station", RAILWAY, NO_GROUP, 2000, 0, -1, 0, 0, 0, 0},
    ...
    {15, "Kandy Railway Station", RAILWAY, NO_GROUP, 2000, 0, -1, 0, 0, 0, 0},
    ...
    {25, "Galle Railway Station", RAILWAY, NO_GROUP, 2000, 0, -1, 0, 0, 0, 0},
    ...
    {35, "Jaffna Railway Station", RAILWAY, NO_GROUP, 2000, 0, -1, 0, 0, 0, 0},
