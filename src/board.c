...
static const Square BOARD_TEMPLATE[BOARD_SIZE] = {
    ...
    {5, "Colombo Fort Railway Station", RAILWAY, NO_GROUP, 0, 0, -1, 0, 0},
    ...
    {12, "Ceylon Electricity Board", UTILITY, NO_GROUP, 0, 0, -1, 0, 0},
    {13, "Maharagama", PROPERTY, PINK, 3800, 280, -1, 0, 0},
    {14, "Kottawa", PROPERTY, PINK, 4000, 300, -1, 0, 0},
    {15, "Kandy Railway Station", RAILWAY, NO_GROUP, 0, 0, -1, 0, 0},
    ...
    {25, "Galle Railway Station", RAILWAY, NO_GROUP, 0, 0, -1, 0, 0},
    {26, "Galle Fort", PROPERTY, YELLOW, 6500, 600, -1, 0, 0},
    {27, "Unawatuna", PROPERTY, YELLOW, 6800, 620, -1, 0, 0},
    {28, "National Water Supply and Drainage Board", UTILITY, NO_GROUP, 0, 0, -1, 0, 0},
    ...
    {35, "Jaffna Railway Station", RAILWAY, NO_GROUP, 0, 0, -1, 0, 0},
